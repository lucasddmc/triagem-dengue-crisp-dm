"""
LightGBM (v2_smote) — balanceamento via SMOTE no train fold de cada CV.

Mesmo grid do v1_baseline (com mesmo fix de `n_jobs=1` no classifier pra evitar
oversubscription). SMOTE inserido via `extra_pipeline_steps`. Hipótese: gap
train-val do v1 (0.25) deve diminuir; recall_alerta_grave (0.022 no v1) deve
subir significativamente.

Execução: python experiments/run_lightgbm_v2.py
"""
import sys
